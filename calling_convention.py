...
def display_x86_global_calling_convention(console):
    ...
    detection_table = Table(show_header=True, header_style="bold white")
    detection_table.add_column("Convention", style="bold white")
    detection_table.add_column("Detection Method", style="bold white")
